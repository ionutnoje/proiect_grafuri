public class Ant
{
    ...
    public Ant(int tourSize)                //functia de initializare a drumului si vectorului de orase vizitate sau nevizitate
    {
        ...
        this.trail = new int[tourSize];     //cred ca se updateaza in timpul codului cu numarul de orase prin care a trecut
    ...
    protected void visitedCityJ(int currentIndex, int city)     //functie care seteaza orasul curent pe oras vizitat cu ajutorul functiei visited
    {
